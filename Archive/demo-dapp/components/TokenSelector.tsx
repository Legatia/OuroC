...
interface TokenSelectorProps {
  selectedToken: 'USDC' | 'USDT' | 'PYUSD' | 'DAI'
  onTokenChange: (token: 'USDC' | 'USDT' | 'PYUSD' | 'DAI') => void
...
const isTokenAvailableOnDevnet = (token: 'USDC' | 'USDT' | 'PYUSD' | 'DAI'): boolean => {
  return token === 'USDC'
}
...
export const TokenSelector: React.FC<TokenSelectorProps> = ({
  ...
  const tokens: Array<'USDC' | 'USDT' | 'PYUSD' | 'DAI'> = ['USDC', 'USDT', 'PYUSD', 'DAI']

  const handleTokenSelect = (token: 'USDC' | 'USDT' | 'PYUSD' | 'DAI') => {
