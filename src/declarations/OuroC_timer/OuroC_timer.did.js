export const idlFactory = ({ IDL }) => {
  ...
  const Result_12 = IDL.Variant({ 'ok' : TransactionHash, 'err' : IDL.Text });
  ...
  const Result_11 = IDL.Variant({ 'ok' : SubscriptionId, 'err' : IDL.Text });
  ...
  return IDL.Service({
    ...
    'get_comprehensive_wallet_info' : IDL.Func([], [Result_10], []),
    ...
    'get_fee_config' : IDL.Func([], [Result_8], []),
